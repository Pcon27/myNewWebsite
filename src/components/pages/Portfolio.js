...
<div>
  ...
  <section id="otherProjects" className="SMLPJ">
        ...
        <div id="BudgetTracker" className="SMLPJ">
            <label>Budget Tracker Project <a href="https://github.com/Pcon27/BudgetTracker">Repo</a></label>
        ...
        <div id="PWGen" className="SMLPJ">
            <label>Password Generator Project <a href="https://github.com/Pcon27/Generate-a-password-repo">Repo</a></label>
        ...
        <div id="workoutTracker" className="SMLPJ">
            <label>Workout Tracker Project <a href="https://github.com/Pcon27/Fitness_Tracker">Repo</a></label>
